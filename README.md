...
$${\color{red}Two \space different \space models \space were \space trained \space and \space evaluated. \space One \space custom \space model \space and \space the \space resnet50 \space model. \space The \space custom \hfill\break model \space evaluation \space gave \space a \space better \space valuation \space accuracy \space score \space so \space this \space model \space is \space used \space in \space the \space application.}$$
