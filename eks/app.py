...
def main():
    ...
    st.set_page_config(page_title="Traffic sign classification app (EKS Version)", menu_items=None, page_icon="random")
    
    # Set page title
    st.markdown('### Traffic sign classification app (EKS Version)')
